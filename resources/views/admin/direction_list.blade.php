                ...
                <div class="col-sm-12">
                    <div class="card">
                                        ...
                                        <tbody>
                                            @foreach ($directions as $direction)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td><a href="{{ route('direction.delete', ['id' => $direction->id]) }}"><button
                                                                class="btn btn-danger" type="button">Удалить</button></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                        ...
                        <div class="card-footer text-end">
                            <button class="btn btn-primary" type="button" id="add_direction_button" data-bs-toggle="modal"
                                data-bs-target="#exampleModalCenter" data-bs-original-title=""
                                        ...
                                        <form id="new_direction_form" method="POST" action="{{route('direction.add')}}">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col">
                                                        <div class="mb-3">
                                                            <input class="form-control input-air-primary" id="new_direction"
                                                                name="new_direction" type="text" value="" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <button class="btn btn-secondary" type="button" data-bs-dismiss="modal"
                                                    data-bs-original-title="" title="">Закрыть</button>
                                                <button class="btn btn-primary" type="submit" data-bs-original-title=""
                                                    id="direction_save" title="">Сохранить</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
