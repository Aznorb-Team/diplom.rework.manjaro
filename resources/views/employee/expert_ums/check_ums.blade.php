      ...
      <div class="row">
        <div class="col-sm-12">
            <div class="card">
                        ...
                        <div class="collapse" id="collapseThree" aria-labelledby="headingThree" data-bs-parent="#accordion" style="">
                          <div class="card-body input-air-primary">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        <input type="text" class="form-control" id="link_statement" value="{{$application->ums_statement->link}}" hidden/>
                ...
                <form class="form theme-form" action='{{route('expert_ums.success', ['id'=> $application->id, 'survey_id' => $survey->id])}}' method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <h4>{{$survey->title}}</h4>
                            ...
                            @case(1)
                                <div class="form-outline border px-2 py-2 input-air-primary">
                                    <div class="form-floating">
                                        <textarea class="form-control input-air-primary" placeholder="Leave a comment here" name="{{$question->id}}" id="{{$question->id}}" style="min-height: 150px;" required></textarea>
                    ...
                    <div class="card-footer text-end">
                        ...
                        <a href="{{route('expert_ums.unsuccess', ['id'=> $application->id])}}"><button class="btn btn-danger" type="button">Не прошел</button></a>
                    </div>
                </form>
            </div>
        </div>
...
<script>
    ...
    document.getElementById('download_statement').onclick = function() {
        ...
        download('http://127.0.0.1:8000/storage/'+link.value, 'ums_statement.pdf');
    };
