            ...
            <div class="card">
                <div class="card-header pb-0">
                  ...
                  <div class="card-footer text-end">
                    <a href="{{route('session_ums.success', ['id'=> $application->id])}}"><button class="btn btn-primary" type="button">Прошел</button></a>
                    <a href="{{route('session_ums.unsuccess', ['id'=> $application->id])}}"><button class="btn btn-danger" type="button">Не прошел</button></a>
                  </div>
            </div>
        </div>
      </div>
